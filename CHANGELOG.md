...
## [0.9.12](https://github.com/michaelbuchar/reana-commons/compare/0.9.11...0.9.12) (2026-08-19)


### Build

* **python:** add support for Python 3.14 ([#506](https://github.com/michaelbuchar/reana-commons/issues/506)) ([bbaf884](https://github.com/michaelbuchar/reana-commons/commit/bbaf8847a3b5a3e2ebf78c10f261e72a4d16fcf9))
* **python:** add support for Python 3.15 ([#554](https://github.com/michaelbuchar/reana-commons/issues/554)) ([afee5e0](https://github.com/michaelbuchar/reana-commons/commit/afee5e0e83b24e355934a7aefe1d3d91fdfe34cc))
* **python:** bump kubernetes lower pin to 23.6.0 ([#517](https://github.com/michaelbuchar/reana-commons/issues/517)) ([3ad24e2](https://github.com/michaelbuchar/reana-commons/commit/3ad24e215448a3279c36c5b96ed906347e580acf))
* **python:** pin google-auth for Python 3.8 compatibility ([#510](https://github.com/michaelbuchar/reana-commons/issues/510)) ([c35eeca](https://github.com/michaelbuchar/reana-commons/commit/c35eecacde97e86c3286e47074a41b6e5d38d0b0))
* **python:** pin setuptools below 81 ([#513](https://github.com/michaelbuchar/reana-commons/issues/513)) ([e435058](https://github.com/michaelbuchar/reana-commons/commit/e435058fb4169c3457dbb51305504bf7fa5168e0))
* **python:** remove kubernetes upper version pin ([#520](https://github.com/michaelbuchar/reana-commons/issues/520)) ([ca531ff](https://github.com/michaelbuchar/reana-commons/commit/ca531ff719587e2bda3155b178940a8497c89dfe))
* **python:** upgrade to Snakemake 9.16.3 ([#514](https://github.com/michaelbuchar/reana-commons/issues/514)) ([621d52e](https://github.com/michaelbuchar/reana-commons/commit/621d52e8ce68172033f2f73b3c8fa0a8c9b42a1f))
* **python:** upgrade to Snakemake 9.22.0 ([#540](https://github.com/michaelbuchar/reana-commons/issues/540)) ([8a9afeb](https://github.com/michaelbuchar/reana-commons/commit/8a9afebb567fae2d0d6ed8d9462e904f9ba3cc2a))


### Features

* **k8s:** harden kerberos sidecars for non-root ([#549](https://github.com/michaelbuchar/reana-commons/issues/549)) ([409d1c6](https://github.com/michaelbuchar/reana-commons/commit/409d1c6712e445994152235c5eacee2d12466bfc))
* **k8s:** set explicit runAsNonRoot on Kerberos sidecars ([#534](https://github.com/michaelbuchar/reana-commons/issues/534)) ([e92b4a9](https://github.com/michaelbuchar/reana-commons/commit/e92b4a90d15fcb5caf4ec51b5af21f3160cf855c))
* **openapi:** add delete token management endpoint ([#529](https://github.com/michaelbuchar/reana-commons/issues/529)) ([757d2eb](https://github.com/michaelbuchar/reana-commons/commit/757d2eb8666e3d6be6882afd8cd3e06c293d64b5))
* **openapi:** add gitlab_host to info endpoint ([#498](https://github.com/michaelbuchar/reana-commons/issues/498)) ([d7c27ac](https://github.com/michaelbuchar/reana-commons/commit/d7c27aced2987bf3e69ddd41c3a4ae2b126f591d))
* **openapi:** add info on Kubernetes job user ID minimum ([#531](https://github.com/michaelbuchar/reana-commons/issues/531)) ([de7198f](https://github.com/michaelbuchar/reana-commons/commit/de7198f06622347c3d0e0518d95df879600d9ff6))
* **openapi:** add K8s resource requests and limits in reana.yaml ([#486](https://github.com/michaelbuchar/reana-commons/issues/486)) ([c782a14](https://github.com/michaelbuchar/reana-commons/commit/c782a14bd7625647515b903743a725b85f53551a))
* **openapi:** add quota management endpoint ([#505](https://github.com/michaelbuchar/reana-commons/issues/505)) ([1646408](https://github.com/michaelbuchar/reana-commons/commit/1646408f7bcaeff9ae174c3609e3c1b3912f0858))
* **openapi:** add quota period endpoint ([#521](https://github.com/michaelbuchar/reana-commons/issues/521)) ([a4f99dd](https://github.com/michaelbuchar/reana-commons/commit/a4f99dd193a654b7a09c64d379d1f83a1d7cf8dc))
* **openapi:** add vetted workflow images to info endpoint ([#497](https://github.com/michaelbuchar/reana-commons/issues/497)) ([228e358](https://github.com/michaelbuchar/reana-commons/commit/228e358545c2720aa69e50a59252a4eb88982541))
* **openapi:** sync bundled specs with components ([#523](https://github.com/michaelbuchar/reana-commons/issues/523)) ([a8703f0](https://github.com/michaelbuchar/reana-commons/commit/a8703f07ebfcf659fe10d4c904d9b3d28ae1c00e))
* **pytest:** add reana_commons.testing pytest plugin ([#524](https://github.com/michaelbuchar/reana-commons/issues/524)) ([2555d25](https://github.com/michaelbuchar/reana-commons/commit/2555d251958b769f35a113739f37ab79682425c0))
* **schema:** add HTCondor CPU/memory/disk/requirements hints ([#537](https://github.com/michaelbuchar/reana-commons/issues/537)) ([23a257a](https://github.com/michaelbuchar/reana-commons/commit/23a257a874a6e8ed1a91aaf0ca9d2528a9813c52))
* **validation:** extract CWL/Yadage/serial image helpers ([#497](https://github.com/michaelbuchar/reana-commons/issues/497)) ([4dce11e](https://github.com/michaelbuchar/reana-commons/commit/4dce11e03c55e1007cc2472749e604cb0e2b7bea))
* **validation:** support server-side workflow validation ([#547](https://github.com/michaelbuchar/reana-commons/issues/547)) ([0ad7953](https://github.com/michaelbuchar/reana-commons/commit/0ad79534517b580592afb416dcb3b2569d8f7409))


### Bug fixes

* **config:** use glob for egg-info in flake8 exclude ([#493](https://github.com/michaelbuchar/reana-commons/issues/493)) ([fe6cc0b](https://github.com/michaelbuchar/reana-commons/commit/fe6cc0b1a319aeb6ef323b121eab272e8a478be5))
* **openapi:** add gitlab_host schema definition ([#511](https://github.com/michaelbuchar/reana-commons/issues/511)) ([b1eb50d](https://github.com/michaelbuchar/reana-commons/commit/b1eb50d47cdaeee6b4ab2aef6e70f43a5555e8dd))
* **openapi:** sync vetted container wording with reana-server ([#538](https://github.com/michaelbuchar/reana-commons/issues/538)) ([f2ed9a1](https://github.com/michaelbuchar/reana-commons/commit/f2ed9a186ab40410d288029d7552f831132142d3))
* **openapi:** update server and job controller schemas ([#488](https://github.com/michaelbuchar/reana-commons/issues/488)) ([c782a14](https://github.com/michaelbuchar/reana-commons/commit/c782a14bd7625647515b903743a725b85f53551a))
* **schema:** accept unpacked_img as serial step property ([#532](https://github.com/michaelbuchar/reana-commons/issues/532)) ([e7b04e5](https://github.com/michaelbuchar/reana-commons/commit/e7b04e5de94fdb7923b28ad6c078acc4d0a677dd)), closes [#530](https://github.com/michaelbuchar/reana-commons/issues/530)
* **snakemake:** validate workflow container images ([#542](https://github.com/michaelbuchar/reana-commons/issues/542)) ([d767e1f](https://github.com/michaelbuchar/reana-commons/commit/d767e1f7cb6f43e2d27f34ead8998d92e4eb88d7))
* **validation:** add missing properties to analysis schema ([#499](https://github.com/michaelbuchar/reana-commons/issues/499)) ([65caae7](https://github.com/michaelbuchar/reana-commons/commit/65caae7d7fb7b1188944a9210a32594088a3af17))
* **workspace:** create files without executable bits ([#551](https://github.com/michaelbuchar/reana-commons/issues/551)) ([e9341f0](https://github.com/michaelbuchar/reana-commons/commit/e9341f05a0a4c0226b0a369fd01eb82c9c423d97))


### Code refactoring

* **config:** replace deprecated pkg_resources ([#503](https://github.com/michaelbuchar/reana-commons/issues/503)) ([a4d08b5](https://github.com/michaelbuchar/reana-commons/commit/a4d08b56695033c8078b054fe33bf8b2f9bd34c4)), closes [#502](https://github.com/michaelbuchar/reana-commons/issues/502)


### Code style

* **openapi:** exclude OpenAPI specs from Prettier formatting ([#518](https://github.com/michaelbuchar/reana-commons/issues/518)) ([6ea4a3f](https://github.com/michaelbuchar/reana-commons/commit/6ea4a3fea9d9367406fe1af3edf6ac4c26e5df22))
* **python:** adapt code base to the new black version ([#511](https://github.com/michaelbuchar/reana-commons/issues/511)) ([0050988](https://github.com/michaelbuchar/reana-commons/commit/005098867b0b386c8869216542cdcc6b63b0b9e8))


### Test suite

* **api-client:** use mock.Mock to match cache isinstance check ([#526](https://github.com/michaelbuchar/reana-commons/issues/526)) ([65309d3](https://github.com/michaelbuchar/reana-commons/commit/65309d34935a061706f08b4b97dcafc1f2abc439))


### Continuous integration

* **commitlint:** fix local running of commit linter on macOS ([#496](https://github.com/michaelbuchar/reana-commons/issues/496)) ([cbdd7ab](https://github.com/michaelbuchar/reana-commons/commit/cbdd7ab92cf21d701ffc1e5bcc57bc62268300cd))
* **jsonlint:** add JSON linting checks ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([c9eeb60](https://github.com/michaelbuchar/reana-commons/commit/c9eeb608483297a021ced5f05f3ae0610a5f00ba))
* **markdownlint:** add Markdown linting checks ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([ce54097](https://github.com/michaelbuchar/reana-commons/commit/ce5409738f4e5642ef558a7dbb76ba9ef5cd6471))
* **prettier:** add Prettier code formatting checks ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([06cd6ab](https://github.com/michaelbuchar/reana-commons/commit/06cd6abc685df8993a960dd531f9aedcb9a3e58f))
* **run-tests:** add usage help and refactor options ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([1f24d95](https://github.com/michaelbuchar/reana-commons/commit/1f24d95bcf768db422a2c7b62e66dae173624afb))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#490](https://github.com/michaelbuchar/reana-commons/issues/490)) ([c782a14](https://github.com/michaelbuchar/reana-commons/commit/c782a14bd7625647515b903743a725b85f53551a))
* **runners:** upgrade CI runners to Ubuntu 22.04 ([#490](https://github.com/michaelbuchar/reana-commons/issues/490)) ([6a582a9](https://github.com/michaelbuchar/reana-commons/commit/6a582a946d52eae76b69d87ce3995a172867b8ba))
* **shfmt:** add shfmt code formatting checks ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([22590a0](https://github.com/michaelbuchar/reana-commons/commit/22590a09383b16f9ec32f6856cff7289777eaa8c))
* **yamllint:** add YAML linting checks ([#516](https://github.com/michaelbuchar/reana-commons/issues/516)) ([92a434e](https://github.com/michaelbuchar/reana-commons/commit/92a434ece21855907ce9cca2bbcca2db715ebcdf))
